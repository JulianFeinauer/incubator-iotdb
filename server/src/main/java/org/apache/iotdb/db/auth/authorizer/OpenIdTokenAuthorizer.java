 ...
 */
public class OpenIdTokenAuthorizer extends BasicAuthorizer {

    private static final Logger logger = LoggerFactory.getLogger(OpenIdTokenAuthorizer.class);
    ...
    public OpenIdTokenAuthorizer() throws AuthException, ParseException, IOException, URISyntaxException {
        this(config.getOpenIdProviderUrl());
    }

    OpenIdTokenAuthorizer(JSONObject jwk) throws AuthException {
    ...
    OpenIdTokenAuthorizer(String providerUrl) throws AuthException, URISyntaxException, ParseException, IOException {
    ...
    private static JSONObject getJWKfromProvider(String providerUrl) throws URISyntaxException, IOException, ParseException, AuthException {
        ...
        try {
            URL url = providerMetadata.getJWKSetURI().toURL();
