...
public class CreateElementaryTimeSeriesPlan extends CreateTimeSeriesPlan {

  private TSDataType dataType;
  private TSEncoding encoding;
  private CompressionType compressor;

  public CreateElementaryTimeSeriesPlan() {
    super(false, Operator.OperatorType.CREATE_TIMESERIES);
    canBeSplit = false;
  }

  public CreateElementaryTimeSeriesPlan(Path path, TSDataType dataType, TSEncoding encoding,
  ...
  public boolean equals(Object o) {
    ...
    CreateElementaryTimeSeriesPlan that = (CreateElementaryTimeSeriesPlan) o;
