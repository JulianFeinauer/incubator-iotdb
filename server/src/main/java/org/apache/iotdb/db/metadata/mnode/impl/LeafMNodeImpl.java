...
public class LeafMNodeImpl extends MNodeBase implements LeafMNode {

  private static final Logger logger = LoggerFactory.getLogger(LeafMNodeImpl.class);
   ...
   */
  public LeafMNodeImpl(MNode parent, String measurementName, String alias, TSDataType dataType,
  ...
  @Override
  public MNodeBase getChild(String name) {
