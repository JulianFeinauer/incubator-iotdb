...
public class IoTDBCreateStructuredIT {
...
//  }
  ...
  public void insertValue() throws ClassNotFoundException {
    String[] retArray = new String[]{
        "root.sg1.d1.structured,null,root.sg1,STRUCTURED,PLAIN,SNAPPY,",
        "root.sg1.d1.structured.a,null,root.sg1,FLOAT,PLAIN,SNAPPY,",
    };
    ...
    try (Connection connection = DriverManager
      ...
      statement.execute("INSERT INTO root.sg1.d1 (timestamp, structured) VALUES (NOW(), \"{\\\"a\\\":1.0}\")");
